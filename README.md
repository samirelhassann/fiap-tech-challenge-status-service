# FIAP SOAT - Grupo 65 - Tech Challenge #04 - Status Service

Repositório do Tech Challenge #04 da FIAP/Alura, no curso SOAT3. 

Este projeto é uma evolução do projeto do Tech Challenge #03. Nele é tratado o microserviço de Status.
...
- swagger: http://localhost:3004/docs-swagger
- redoc: http://localhost:3004/docs
